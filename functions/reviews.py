...
cloudant_username = '8ddd43af-be7b-4701-9f1a-bfe3a7352262-bluemix'
cloudant_api_key = 'CAbamhA1GeZZxt8yo9qKtb-y1aThZkYKGPNl43YJWY6g'
cloudant_url = 'https://8ddd43af-be7b-4701-9f1a-bfe3a7352262-bluemix.cloudantnosqldb.appdomain.cloud'
...
def post_review():
    ...
    required_fields = ['review_id', 'name', 'dealership', 'review', 'purchase', 'purchase_date', 'car_make', 'car_model', 'car_year']
